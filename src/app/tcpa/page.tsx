        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="mt-16 grid gap-8 md:grid-cols-3">
            {[
              {
                quote:
                  "I was getting 5 spam texts a day from a company I'd never even heard of. Olivia Claims got me a settlement I never expected. Took me two minutes to start.",
                name: "Maria R.",
                location: "Houston, TX",
              },
              {
      ...
      <footer className="relative z-10 border-t border-gray-100 py-12">
        <div className="mx-auto max-w-7xl px-6">
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            <span className="text-sm font-semibold text-gray-900">Olivia Claims</span>
            <a href="tel:+19543200708" className="text-sm text-gray-500 hover:text-gray-700">(954) 320-0708</a>
            <p className="text-xs text-gray-400">
              &copy; {new Date().getFullYear()} Olivia Claims. All rights reserved. This is attorney advertising and not legal advice. Estimates are not a guarantee of recovery.
            </p>
          </div>
        </div>
      </footer>
